...
const carouselsData = {
  ...
  racionalizacion: {
    ...
    progressPct: 0,
    items: [
      { src: 'Imágenes/k01 Racionalizacion/01 racionalizacion.PNG', caption: '01 Evaluación para la Priorización - Racionalización' },
      { src: 'Imágenes/k01 Racionalizacion/02 racionalizacion.PNG', caption: '02 Análisis de Viabilidad y Criterios' },
      { src: 'Imágenes/k01 Racionalizacion/03 racionalizacion.PNG', caption: '03 Evaluación para la Automatización Tecnológica' },
      { src: 'Imágenes/k01 Racionalizacion/04 racionalizacion.PNG', caption: '04 Seguimiento, Control y Reportería de Trámites' },
      { src: 'Imágenes/k01 Racionalizacion/05 racionalizacion.PNG', caption: '05 Consolidado General y Fichas por Proceso' }
    ]
  },
  rxd: {
    slideIndex: 11,
